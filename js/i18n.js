...
const I18N_STRINGS = {
  "zh": {
    ...
    "compare.title.airports": "並排比較機場",
    "compare.mode.aircraft": "機型",
    "compare.mode.airports": "機場",
    "compare.add": "＋ 加入機型",
    "compare.remove": "移除",
  ...
  "en": {
    ...
    "compare.title.airports": "Compare Airports",
    "compare.mode.aircraft": "Aircraft",
    "compare.mode.airports": "Airports",
  ...
  "ja": {
    ...
    "compare.title.airports": "空港を並べて比較",
    "compare.mode.aircraft": "機種",
    "compare.mode.airports": "空港",
    "compare.add": "＋ 機種を追加",
    "compare.remove": "削除",
