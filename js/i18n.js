...
const I18N_STRINGS = {
  "zh": {
    ...
    "home.compare.title": "機型比較",
    "home.compare.desc": "多架機型並排比對規格、尺寸與外觀",
    ...
    "airports.view.globeHint": "拖曳旋轉・滾輪縮放・點擊光點開啟機場",
  ...
  "en": {
    ...
    "home.compare.title": "Aircraft Compare",
    "home.compare.desc": "Compare specs, dimensions and silhouettes side by side",
    ...
    "airports.view.globeHint": "Drag to rotate · Scroll to zoom · Click a dot to open",
  ...
  "ja": {
    ...
    "home.compare.title": "機種比較",
    "home.compare.desc": "複数機種の諸元・寸法・シルエットを並べて比較",
    ...
    "airports.view.globeHint": "ドラッグで回転・スクロールで拡大縮小・点をクリックで開く",
