...
const I18N_STRINGS = {
  "zh": {
    ...
    "home.foot": "HANGAR ARCHIVE — 飛行器與機場的互動資料庫",
    "nav.airports": "🛬 機場與跑道",
    "variants.eyebrow": "HANGAR ARCHIVE / 機庫檔案 — REFERENCE",
    "variants.title": "機型家族與次型號對照",
    "variants.lede": "機庫檔案目前收錄 40 個機型條目，多數對應到某個機型家族裡的「一個」次型號（如 737-800 只是 737NG 家族四型之一）。本表依製造商整理各家族的完整次型號系譜，標出本站目前收錄哪一型、以及該型的 ICAO／IATA 機型代號。",
    ...
    "airports.eyebrow": "HANGAR ARCHIVE / 機庫檔案",
  ...
  "en": {
    ...
    "home.foot": "HANGAR ARCHIVE — an interactive database of aircraft and airports",
    "nav.airports": "🛬 Airports & Runways",
    "variants.eyebrow": "HANGAR ARCHIVE — REFERENCE",
    ...
    "airports.eyebrow": "HANGAR ARCHIVE",
  ...
  "ja": {
    ...
    "home.foot": "HANGAR ARCHIVE — 航空機と空港のインタラクティブ・データベース",
    "nav.airports": "🛬 空港・滑走路",
    "variants.eyebrow": "HANGAR ARCHIVE — REFERENCE",
