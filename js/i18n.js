...
const I18N_STRINGS = {
  "zh": {
    ...
    "airports.detail.save": "儲存",
    "airports.detail.cancel": "取消",
    "airports.detail.notesLocal": "＊僅儲存在你的瀏覽器（本機），不會同步給其他人。",
  ...
  "en": {
    ...
    "airports.detail.save": "Save",
    "airports.detail.cancel": "Cancel",
    "airports.detail.notesLocal": "＊Saved only in your browser (local) — not shared with anyone else.",
  ...
  "ja": {
    ...
    "airports.detail.save": "保存",
    "airports.detail.cancel": "キャンセル",
    "airports.detail.notesLocal": "＊このブラウザにのみ保存され、他の人とは共有されません。",
    "airports.flag.lit": "夜間照明",
