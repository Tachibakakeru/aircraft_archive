...
const I18N_STRINGS = {
  "zh": {
    ...
    "home.fleet.desc": "40 款機型的 3D 互動檢視、規格比對與家族系譜",
    "home.airports.title": "機場與跑道",
    "home.airports.desc": "全球機場搜尋、跑道明細與 ICAO／IATA 代號",
    "home.foot": "SKY ARCHIVE — 飛行器與機場的互動資料庫",
    "nav.airports": "🛬 機場與跑道",
    "variants.eyebrow": "SKY ARCHIVE / 天空檔案 — REFERENCE",
    "variants.title": "機型家族與次型號對照",
    "variants.lede": "天空檔案目前收錄 40 個機型條目，多數對應到某個機型家族裡的「一個」次型號（如 737-800 只是 737NG 家族四型之一）。本表依製造商整理各家族的完整次型號系譜，標出本站目前收錄哪一型、以及該型的 ICAO／IATA 機型代號。",
  ...
  "en": {
    ...
    "home.fleet.desc": "3D interactive views, spec comparisons and variant lineage for 40 aircraft",
    "home.airports.title": "Airports & Runways",
    "home.airports.desc": "Search airports worldwide, view runway details and ICAO/IATA codes",
    "home.foot": "SKY ARCHIVE — an interactive database of aircraft and airports",
    "nav.airports": "🛬 Airports & Runways",
    "variants.eyebrow": "SKY ARCHIVE — REFERENCE",
    "variants.title": "Type Families & Variants",
    "variants.lede": "The archive currently covers 40 entries, most representing a single variant within a larger type family (e.g. the 737-800 is just one of four 737NG variants). This reference lists each family's full variant lineage, marking which one this site covers and its ICAO/IATA type code. (Family notes below are in Chinese only for now.)",
  ...
  "ja": {
    ...
    "home.fleet.desc": "40 機種の 3D インタラクティブ表示、諸元比較、系列対照",
    "home.airports.title": "空港・滑走路",
    "home.airports.desc": "世界の空港検索、滑走路情報、ICAO／IATA コード",
    "home.foot": "SKY ARCHIVE — 航空機と空港のインタラクティブ・データベース",
    "nav.airports": "🛬 空港・滑走路",
    "variants.eyebrow": "SKY ARCHIVE — REFERENCE",
    "variants.title": "機種ファミリーと派生型対照表",
    "variants.lede": "現在 40 機種を収録、多くは機種ファミリーの中の「1つ」の派生型です（737-800 も 737NG ファミリー4型のうちの1つ）。本表はメーカー別に各ファミリーの派生型系譜を整理し、本サイトが収録している型式と ICAO／IATA 型式コードを示します（下記の詳細解説は現在中国語のみ）。",
