...
const I18N_STRINGS = {
  "zh": {
    ...
    "airports.prompt": "輸入關鍵字、或選擇國家／類別開始搜尋（全庫共 9,772 座機場）。",
  ...
  "en": {
    ...
    "airports.prompt": "Type a keyword, or pick a country/type to start (9,772 airports in the index).",
  ...
  "ja": {
    ...
    "airports.prompt": "キーワードを入力するか、国／種別を選んで検索を始めてください（全 9,772 空港収録）。",
